...
class final_topo(Topo):
  def build(self):
    ...
    h_untrust = self.addHost('h_untrust',mac='00:00:00:00:00:04',ip='172.16.10.100/24', defaultRoute="h_untrust-eth0")
    h_server = self.addHost('h_server',mac='00:00:00:00:00:05',ip='10.0.4.10/24', defaultRoute="h_server-eth0")
    ...
    s_core_1 = self.addSwitch('s4') # Core switch
    s_data_1 = self.addSwitch('s5') # Data center switch

    # Connect Port 8 on the Switch to Port 0 on Host 1 and Port 9 on the Switch to Port 0 on 
    # Host 2. This is representing the physical port on the switch or host that you are 
    # connecting to.
    self.addLink(s1,s_core_1, port1=1, port2=2)
    self.addLink(s2,s_core_1, port1=1, port2=3)
    self.addLink(s3,s_core_1, port1=1, port2=4)
    self.addLink(s_data_1,s_core_1, port1=1, port2=5)
    ...
    self.addLink(s_core_1,h_untrust, port1=11, port2=0)
    self.addLink(s_data_1,h_server, port1=12, port2=0)
